package _1_24_0_fla
{
   ...
   public dynamic class Symbol36_939 extends MovieClip
   {
      ...
      public function colorchange2(param1:ColorPickerEvent) : void
      {
         ...
         this.top.FrontRightLowerArm.color2.transform.colorTransform = this.colorInfo2;
         this.top.FrontLeftLowerArm.color2.transform.colorTransform = this.colorInfo2;
      }
      ...
      function frame1() : *
      {
         ...
         this.cpicker4.selectedColor = 10647384;
         ...
         this.cpicker1.selectedColor = 16769469;
