package _1_24_0_fla
{
   ...
   public dynamic class Symbol193_2700 extends MovieClip
   {
      ...
      public function Symbol193_2700()
      {
         super();
      ...
      public function colorchange4(param1:ColorPickerEvent) : void
      {
         ...
         this.top.FrontRightUpperArm.color4.transform.colorTransform = this.colorInfo4;
         this.top.FrontLeftUpperArm.color4.transform.colorTransform = this.colorInfo4;
      }
      
      function frame1() : *
      {
         this.cpicker1.selectedColor = 16764347;
         ...
         this.cpicker2.selectedColor = 10862586;
         this.colorInfo2 = this.top.FrontHips.color2.transform.colorTransform;
         this.cpicker2.addEventListener(ColorPickerEvent.CHANGE,this.colorchange2);
         this.cpicker3.selectedColor = 10877664;
         ...
         this.cpicker4.selectedColor = 16426459;
         this.colorInfo4 = this.top.FrontHips.color4.transform.colorTransform;
