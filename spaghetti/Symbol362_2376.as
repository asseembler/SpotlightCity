package _1_24_0_fla
{
   ...
   public dynamic class Symbol362_2376 extends MovieClip
   {
      ...
      public function Symbol362_2376()
      {
         super();
      ...
      public function colorchange(param1:ColorPickerEvent) : void
      {
         ...
         this.hair.Behindfronthead.hair.color1.transform.colorTransform = this.colorInfo;
      }
      ...
      function frame1() : *
      {
         ...
         this.cpicker3.selectedColor = 14411263;
         ...
         this.cpicker4.selectedColor = 14258687;
         ...
         this.cpicker5.selectedColor = 16769935;
