package _1_24_0_fla
{
   ...
   public dynamic class Symbol328_2215 extends MovieClip
   {
      ...
      public function Symbol328_2215()
      {
         super();
      ...
      public function colorchange(param1:ColorPickerEvent) : void
      {
         ...
         this.shoe.SideLeftFoot.colo1.transform.colorTransform = this.colorInfo;
         this.shoe.FrontRightLowerLeg.color1.transform.colorTransform = this.colorInfo;
         this.shoe.SideLeftLowerLeg.color1.transform.colorTransform = this.colorInfo;
         this.shoe.SideLeftLowerLeg.colo1.transform.colorTransform = this.colorInfo;
      }
      ...
      public function colorchange2(param1:ColorPickerEvent) : void
      {
         ...
         this.shoe.SideLeftLowerLeg.color2.transform.colorTransform = this.colorInfo2;
      }
      ...
      public function colorchange3(param1:ColorPickerEvent) : void
      {
         ...
         this.shoe.SideLeftFoot.color3.transform.colorTransform = this.colorInfo3;
      }
      
      function frame1() : *
      {
         this.cpicker1.selectedColor = 8586244;
         ...
         this.cpicker2.selectedColor = 11833657;
         this.colorInfo2 = this.shoe.SideLeftFoot.color2.transform.colorTransform;
         this.cpicker2.addEventListener(ColorPickerEvent.CHANGE,this.colorchange2);
         this.cpicker3.selectedColor = 15329769;
