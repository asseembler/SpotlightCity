package _1_24_0_fla
{
   ...
   public dynamic class Symbol280_1387 extends MovieClip
   {
      ...
      public function Symbol280_1387()
      {
         super();
      ...
      public function colorchange2(param1:ColorPickerEvent) : void
      {
         ...
         this.hair.Behindfronthead.pony.color2.transform.colorTransform = this.colorInfo2;
      }
      ...
      public function colorchange(param1:ColorPickerEvent) : void
      {
         ...
         this.hair.Behindfronthead.pony.color1.transform.colorTransform = this.colorInfo;
      }
      ...
      function frame1() : *
      {
         ...
         this.cpicker2.selectedColor = 14916177;
