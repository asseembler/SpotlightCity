package _1_24_0_fla
{
   ...
   public dynamic class Symbol67_1122 extends MovieClip
   {
      ...
      public function colorchange(param1:ColorPickerEvent) : void
      {
         ...
         this.shoes.FrontRightFoot.RightShoe.color1.transform.colorTransform = this.colorInfo;
         this.shoes.SideLeftFoot.LeftShoe.color1.transform.colorTransform = this.colorInfo;
         this.shoes.FrontRightLowerLeg.color1.transform.colorTransform = this.colorInfo;
         this.shoes.SideLeftLowerLeg.color1.transform.colorTransform = this.colorInfo;
      }
      
      public function colorchange2(param1:ColorPickerEvent) : void
      {
         this.colorInfo2.color = this.cpicker2.selectedColor;
         this.shoes.SideLeftLowerLeg.color2.transform.colorTransform = this.colorInfo2;
      ...
      public function colorchange3(param1:ColorPickerEvent) : void
      {
         ...
         this.shoes.FrontRightFoot.RightShoe.c31.color3.transform.colorTransform = this.colorInfo3;
         this.shoes.FrontRightFoot.RightShoe.c32.color3.transform.colorTransform = this.colorInfo3;
         this.shoes.FrontRightFoot.RightShoe.c33.color3.transform.colorTransform = this.colorInfo3;
         this.shoes.SideLeftFoot.LeftShoe.c31.color3.transform.colorTransform = this.colorInfo3;
         this.shoes.SideLeftFoot.LeftShoe.c32.color3.transform.colorTransform = this.colorInfo3;
         this.shoes.SideLeftFoot.LeftShoe.c33.color3.transform.colorTransform = this.colorInfo3;
         this.shoes.FrontRightLowerLeg.color3.transform.colorTransform = this.colorInfo3;
         this.shoes.SideLeftLowerLeg.color3.transform.colorTransform = this.colorInfo3;
      }
      
      function frame1() : *
      {
         this.cpicker1.selectedColor = 16777215;
         this.colorInfo = this.shoes.FrontRightFoot.RightShoe.color1.transform.colorTransform;
         this.cpicker1.addEventListener(ColorPickerEvent.CHANGE,this.colorchange);
         this.cpicker2.selectedColor = 15394803;
         this.colorInfo2 = this.shoes.SideLeftLowerLeg.color2.transform.colorTransform;
         this.cpicker2.addEventListener(ColorPickerEvent.CHANGE,this.colorchange2);
         this.cpicker3.selectedColor = 16777215;
         this.colorInfo3 = this.shoes.FrontRightFoot.RightShoe.c31.color3.transform.colorTransform;
