package _1_24_0_fla
{
   ...
   public dynamic class Symbol268_2852 extends MovieClip
   {
       
      
      public var bloody:MovieClip;
      ...
      public function Symbol268_2852()
      {
         super();
      ...
      public function colorchange4(param1:ColorPickerEvent) : void
      {
         ...
         this.bloody.FrontTorso.color4.transform.colorTransform = this.colorInfo4;
      }
      
      public function colorchange3(param1:ColorPickerEvent) : void
      {
         this.colorInfo3.color = this.cpicker3.selectedColor;
         this.bloody.FrontTorso.color3.transform.colorTransform = this.colorInfo3;
      }
      
      public function colorchange2(param1:ColorPickerEvent) : void
      {
         this.colorInfo2.color = this.cpicker2.selectedColor;
         this.bloody.FrontTorso.color2.transform.colorTransform = this.colorInfo2;
      }
      
      public function colorchange1(param1:ColorPickerEvent) : void
      {
         this.colorInfo1.color = this.cpicker1.selectedColor;
         this.bloody.FrontTorso.color1.transform.colorTransform = this.colorInfo1;
      }
      
      function frame1() : *
      {
         this.cpicker4.selectedColor = 16751001;
         this.colorInfo4 = this.bloody.FrontTorso.color4.transform.colorTransform;
         this.cpicker4.addEventListener(ColorPickerEvent.CHANGE,this.colorchange4);
         this.cpicker3.selectedColor = 13369344;
         this.colorInfo3 = this.bloody.FrontTorso.color3.transform.colorTransform;
         this.cpicker3.addEventListener(ColorPickerEvent.CHANGE,this.colorchange3);
         this.cpicker2.selectedColor = 7733505;
         this.colorInfo2 = this.bloody.FrontTorso.color2.transform.colorTransform;
         this.cpicker2.addEventListener(ColorPickerEvent.CHANGE,this.colorchange2);
         this.cpicker1.selectedColor = 16777215;
         this.colorInfo1 = this.bloody.FrontTorso.color1.transform.colorTransform;
