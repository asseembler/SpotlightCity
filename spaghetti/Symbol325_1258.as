package _1_24_0_fla
{
   ...
   public dynamic class Symbol325_1258 extends MovieClip
   {
      ...
      public function Symbol325_1258()
      {
         super();
      ...
      public function colorchange1(param1:ColorPickerEvent) : void
      {
         ...
         this.top.FrontTorso.colo1.transform.colorTransform = this.colorInfo1;
         this.top.FrontRightLowerArm.color1.transform.colorTransform = this.colorInfo1;
         this.top.FrontLeftLowerArm.color1.transform.colorTransform = this.colorInfo1;
         this.top.FrontRightLowerArm.colo1.transform.colorTransform = this.colorInfo1;
         this.top.FrontLeftLowerArm.colo1.transform.colorTransform = this.colorInfo1;
      ...
      function frame1() : *
      {
         this.cpicker4.selectedColor = 16110172;
         this.colorInfo4 = this.top.FrontTorso.colo4.transform.colorTransform;
         this.cpicker4.addEventListener(ColorPickerEvent.CHANGE,this.colorchange4);
         this.cpicker3.selectedColor = 16110172;
