package _1_24_0_fla
{
   ...
   public dynamic class Symbol336_2911 extends MovieClip
   {
      ...
      public function Symbol336_2911()
      {
         super();
      ...
      public function colorchange2(param1:ColorPickerEvent) : void
      {
         ...
         this.top.FrontRightUpperArm.color2.transform.colorTransform = this.colorInfo2;
         this.top.FrontLeftUpperArm.color2.transform.colorTransform = this.colorInfo2;
         this.top.FrontTorso.colo2.transform.colorTransform = this.colorInfo2;
         this.top.FrontRightUpperArm.colo2.transform.colorTransform = this.colorInfo2;
         this.top.FrontLeftUpperArm.colo2.transform.colorTransform = this.colorInfo2;
      }
      ...
      public function colorchange3(param1:ColorPickerEvent) : void
      {
         ...
         this.top.FrontLeftUpperArm.color3.transform.colorTransform = this.colorInfo3;
         this.top.FrontTorso.colo3.transform.colorTransform = this.colorInfo3;
         this.top.FrontRightUpperArm.colo3.transform.colorTransform = this.colorInfo3;
         this.top.FrontLeftUpperArm.colo3.transform.colorTransform = this.colorInfo3;
      }
      ...
      public function colorchange4(param1:ColorPickerEvent) : void
      {
         ...
         this.top.FrontTorso.colo4.transform.colorTransform = this.colorInfo4;
      }
      ...
      public function colorchange5(param1:ColorPickerEvent) : void
      {
         ...
         this.top.FrontTorso.colo5.transform.colorTransform = this.colorInfo5;
      }
