package _1_24_0_fla
{
   ...
   public dynamic class Symbol385_2536 extends MovieClip
   {
      ...
      public function Symbol385_2536()
      {
         super();
      ...
      public function colorchange3(param1:ColorPickerEvent) : void
      {
         ...
         this.hair.FrontHead.color31.color3.transform.colorTransform = this.colorInfo3;
         this.hair.FrontHead.color32.color3.transform.colorTransform = this.colorInfo3;
         this.hair.FrontHead.color33.color3.transform.colorTransform = this.colorInfo3;
         this.hair.FrontHead.color34.color3.transform.colorTransform = this.colorInfo3;
      }
      ...
      function frame1() : *
      {
         this.cpicker1.selectedColor = 12173794;
         ...
         this.cpicker2.selectedColor = 8882137;
         ...
         this.cpicker3.selectedColor = 15759275;
         this.colorInfo3 = this.hair.FrontHead.color31.color3.transform.colorTransform;
         this.cpicker3.addEventListener(ColorPickerEvent.CHANGE,this.colorchange3);
         this.cpicker4.selectedColor = 6213066;
         ...
         this.cpicker5.selectedColor = 16444457;
