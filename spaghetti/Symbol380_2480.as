package _1_24_0_fla
{
   ...
   public dynamic class Symbol380_2480 extends MovieClip
   {
      ...
      public function Symbol380_2480()
      {
         super();
      ...
      public function colorchange(param1:ColorPickerEvent) : void
      {
         ...
         this.top.FrontTorso.colo1.transform.colorTransform = this.colorInfo;
      ...
      public function colorchange2(param1:ColorPickerEvent) : void
      {
         ...
         this.top.FrontTorso.co2.transform.colorTransform = this.colorInfo2;
         this.top.FrontRightUpperArm.arm.color2.transform.colorTransform = this.colorInfo2;
