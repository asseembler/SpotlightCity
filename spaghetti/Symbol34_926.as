package _1_24_0_fla
{
   ...
   public dynamic class Symbol34_926 extends MovieClip
   {
      ...
      public function colorchange(param1:ColorPickerEvent) : void
      {
         ...
         this.hair.Behindfronthead.col1.transform.colorTransform = this.colorInfo;
      }
      ...
      function frame1() : *
      {
         ...
         this.cpicker1.selectedColor = 16243939;
         ...
         this.cpicker2.selectedColor = 15767717;
         ...
         this.cpicker3.selectedColor = 4007193;
