package _1_24_0_fla
{
   ...
   public dynamic class Symbol342_141 extends MovieClip
   {
      ...
      public function colorchange5(param1:ColorPickerEvent) : void
      {
         ...
         this.FrontHead.flower2.color5.transform.colorTransform = this.colorInfo5;
      }
      ...
      public function colorchange2(param1:ColorPickerEvent) : void
      {
         ...
         this.FrontHead.flower2.color2.transform.colorTransform = this.colorInfo2;
      }
      ...
      function frame1() : *
      {
         this.cpicker5.selectedColor = 16748993;
         ...
         this.cpicker4.selectedColor = 16734052;
         ...
         this.cpicker3.selectedColor = 10071039;
         ...
         this.cpicker2.selectedColor = 16768052;
         ...
         this.cpicker1.selectedColor = 15200765;
