package _1_24_0_fla
{
   ...
   public dynamic class Symbol43_975 extends MovieClip
   {
      ...
      public function colorchange2(param1:ColorPickerEvent) : void
      {
         ...
         this.shoes.FrontLeftFoot.color2.transform.colorTransform = this.colorInfo2;
      ...
      public function colorchange1(param1:ColorPickerEvent) : void
      {
         ...
         this.shoes.FrontLeftLowerLeg.color1.transform.colorTransform = this.colorInfo1;
         this.shoes.SideRightLowerLeg.color1.transform.colorTransform = this.colorInfo1;
         this.shoes.FrontLeftFoot.color1.transform.colorTransform = this.colorInfo1;
         this.shoes.SideRightFoot.color1.transform.colorTransform = this.colorInfo1;
      }
      
      function frame1() : *
      {
         this.cpicker3.selectedColor = 16777215;
         this.colorInfo3 = this.shoes.FrontLeftLowerLeg.color3.transform.colorTransform;
         this.cpicker3.addEventListener(ColorPickerEvent.CHANGE,this.colorchange3);
         this.cpicker2.selectedColor = 16777215;
         this.colorInfo2 = this.shoes.FrontLeftLowerLeg.color2.transform.colorTransform;
         this.cpicker2.addEventListener(ColorPickerEvent.CHANGE,this.colorchange2);
         this.cpicker1.selectedColor = 13999200;
         this.colorInfo1 = this.shoes.FrontLeftLowerLeg.color1.transform.colorTransform;
