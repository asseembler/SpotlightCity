package _1_24_0_fla
{
   ...
   public dynamic class Symbol104_1041 extends MovieClip
   {
      ...
      public function Symbol104_1041()
      {
         super();
      ...
      public function colorchange(param1:ColorPickerEvent) : void
      {
         ...
         this.dress.SideTorso.color1.transform.colorTransform = this.colorInfo;
         this.dress.SideTorso.col1.transform.colorTransform = this.colorInfo;
         this.dress.SideTorso.c1.transform.colorTransform = this.colorInfo;
      }
      ...
      public function colorchange4(param1:ColorPickerEvent) : void
      {
         ...
         this.dress.FrontTorso.color4.transform.colorTransform = this.colorInfo4;
      }
      
      public function colorchange5(param1:ColorPickerEvent) : void
      {
         this.colorInfo5.color = this.cpicker5.selectedColor;
         this.dress.FrontTorso.color5.transform.colorTransform = this.colorInfo5;
      }
      
      function frame1() : *
      {
         this.cpicker1.selectedColor = 16317695;
         this.colorInfo = this.dress.FrontTorso.color1.transform.colorTransform;
         this.cpicker1.addEventListener(ColorPickerEvent.CHANGE,this.colorchange);
         this.cpicker2.selectedColor = 16766917;
         ...
         this.cpicker3.selectedColor = 15654399;
         ...
         this.cpicker4.selectedColor = 16295507;
         this.colorInfo4 = this.dress.FrontTorso.color4.transform.colorTransform;
         this.cpicker4.addEventListener(ColorPickerEvent.CHANGE,this.colorchange4);
         this.cpicker5.selectedColor = 3091506;
         this.colorInfo5 = this.dress.FrontTorso.color5.transform.colorTransform;
