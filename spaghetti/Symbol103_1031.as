package _1_24_0_fla
{
   ...
   public dynamic class Symbol103_1031 extends MovieClip
   {
      ...
      public function colorchange(param1:ColorPickerEvent) : void
      {
         ...
         this.swan.FrontHead.color1.transform.colorTransform = this.colorInfo;
         this.swan.Behindfronthead.color1.transform.colorTransform = this.colorInfo;
      }
      
      public function colorchange2(param1:ColorPickerEvent) : void
      {
         this.colorInfo2.color = this.cpicker2.selectedColor;
         this.swan.FrontHead.color2.transform.colorTransform = this.colorInfo2;
         this.swan.Behindfronthead.color2.transform.colorTransform = this.colorInfo2;
      }
      
      function frame1() : *
      {
         this.cpicker1.selectedColor = 3287337;
         this.colorInfo = this.swan.FrontHead.color1.transform.colorTransform;
         this.cpicker1.addEventListener(ColorPickerEvent.CHANGE,this.colorchange);
         this.cpicker2.selectedColor = 4074275;
         this.colorInfo2 = this.swan.FrontHead.color2.transform.colorTransform;
