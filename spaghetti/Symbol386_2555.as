package _1_24_0_fla
{
   ...
   public dynamic class Symbol386_2555 extends MovieClip
   {
      ...
      public function Symbol386_2555()
      {
         super();
      ...
      public function colorchange2(param1:ColorPickerEvent) : void
      {
         ...
         this.dress.FrontHips.color2.transform.colorTransform = this.colorInfo2;
         this.dress.FrontHips.colo2.transform.colorTransform = this.colorInfo2;
      }
      ...
      function frame1() : *
      {
         this.cpicker1.selectedColor = 12033248;
         ...
         this.cpicker2.selectedColor = 15759275;
         ...
         this.cpicker3.selectedColor = 7434713;
         ...
         this.cpicker4.selectedColor = 16444457;
