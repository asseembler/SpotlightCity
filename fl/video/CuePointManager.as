package fl.video
{
   ...
   public class CuePointManager
   {
      ...
      public function CuePointManager(param1:FLVPlayback, param2:uint)
      {
         ...
         this._linearSearchTolerance = flvplayback_internal::DEFAULT_LINEAR_SEARCH_TOLERANCE;
      }
      ...
      public function addASCuePoint(param1:*, param2:String = null, param3:Object = null) : Object
      {
         ...
         var _loc8_:Number;
         if((_loc8_ = this._owner.getVideoPlayer(this._id).playheadTime) > 0)
         {
         ...
         var _loc9_:Object;
         (_loc9_ = deepCopyObject(this.asCuePoints[_loc7_])).array = this.asCuePoints;
         _loc9_.index = _loc7_;
         return _loc9_;
      }
      ...
      public function setFLVCuePointEnabled(param1:Boolean, param2:*) : int
      {
         ...
         if(_loc4_)
         {
            ...
            else
            {
               ...
               while(_loc7_ >= 0)
               {
                  ...
                  if((_loc8_ = this.getCuePointIndex(this._disabledCuePoints,true,_loc9_.time)) < 0 || this._disabledCuePoints[_loc8_].time != _loc9_.time)
                  {
         ...
         if((_loc7_ = this.getCuePointIndex(this._disabledCuePoints,false,_loc3_.time,_loc3_.name)) < 0)
         {
            if(param1)
            {
               if(!this._metadataLoaded)
               {
                  if((_loc7_ = this.getCuePointIndex(this._disabledCuePoints,false,_loc3_.time)) < 0)
                  {
            ...
            if(this._metadataLoaded)
            {
               if((_loc7_ = this.getCuePointIndex(this.flvCuePoints,false,_loc3_.time,_loc3_.name)) < 0)
               {
                  return 0;
               }
               if(_loc5_)
      ...
      public function isFLVCuePointEnabled(param1:*) : Boolean
      {
         ...
         if(_loc3_)
         {
            if((_loc5_ = this.getCuePointIndex(this.flvCuePoints,true,-1,_loc2_.name)) < 0)
            {
               return true;
            }
            while(_loc5_ >= 0)
      ...
      public function processCuePointsProperty(param1:Array) : void
      {
         ...
         while(true)
         {
            ...
            (_loc6_ = new Object()).time = param1[_loc8_] / 1000;
            _loc2_++;
         }
      ...
      flvplayback_internal function getCuePointIndex(param1:Array, param2:Boolean, param3:Number = NaN, param4:String = null, param5:int = -1, param6:int = -1) : int
      {
         ...
         if(param6 <= this._linearSearchTolerance)
         {
            ...
            {
               if((_loc9_ = cuePointCompare(param3,param4,param1[_loc15_])) == 0)
               {
                  return _loc15_;
               }
               if(_loc9_ < 0)
         ...
         if((_loc9_ = cuePointCompare(param3,param4,param1[_loc11_])) < 0)
         {
      ...
      flvplayback_internal function getCuePoint(param1:Array, param2:Boolean, param3:*) : Object
      {
         ...
         var _loc5_:int;
         if((_loc5_ = this.getCuePointIndex(param1,param2,_loc4_.time,_loc4_.name)) < 0)
         {
            return null;
         }
         (_loc4_ = deepCopyObject(param1[_loc5_])).array = param1;
         _loc4_.index = _loc5_;
         return _loc4_;
      }
